      ...
      <div class="l-main__contents">
        <div class="p-form__registration">
          ...
          <dl>
            ...
            <dd class="p-form__registration__item"><input type="text" name="your-name" placeholder="名字、イニシャル、ハンドルネーム" v-model="objects.dataObject1.name"></dd>
            <dt class="p-form__registration__stitle">メールアドレス</dt>
            <dd class="p-form__registration__item"><input type="email" name="your-email" placeholder="○○@○○○○.○○○"  v-model="objects.dataObject1.mail"></dd>
            <dt class="p-form__registration__stitle">パスワード</dt>
            <dd class="p-form__registration__item"><input type="password" name="your-password" placeholder="" class="p-form__registration__item__password"  v-model="objects.dataObject1.password"><span class="p-form__registration__item__icon"></span></dd>    
            ...
            <dd class="p-form__registration__item">
              <div class="p-form__registration__item__radio u-fbox">
                <label><input type="radio" name="sex" value="男性" v-model="objects.dataObject1.gender"><span>男性</span></label>
                <label><input type="radio" name="sex" value="女性" v-model="objects.dataObject1.gender"><span>女性</span></label>
              </div>
            </dd>
            <dt class="p-form__registration__stitle">生まれた年</dt><dd class="p-form__registration__item">
              <select name="year" v-model="objects.dataObject1.yearOfBirth">
            ...
            <dt class="p-form__registration__stitle">お住いの都道府県</dt><dd class="p-form__registration__item">
              <select name="pref" v-model="objects.dataObject1.address1">
            ...
            <dd class="p-form__registration__item"><input type="text" name="area" placeholder="市区町村" v-model="objects.dataObject1.address2"></dd>
          </dl>
