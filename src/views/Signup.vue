  ...
  methods: {
    move(nextPageNumber) {
		...
		if(this.pageStatus === 6){
			console.log(this.registrationDataObjects1)
			console.log(this.registrationDataObjects2)
			console.log(this.registrationDataObjects3)
			console.log(this.registrationDataObjects4)
